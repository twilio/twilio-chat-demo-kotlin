...
import com.twilio.chat.app.viewModel.LoginViewModel
...
import com.twilio.chat.app.testUtil.replaceDynamicUi
...
class LoginActivityTest {
    ...
    fun displaysError_onSigninError() {
        activityRule.runOnUiThread {
            loginViewModel.onSignInError.value = ChatError.GENERIC_ERROR
        }
    ...
    @Test
    fun displaysChannelListActivity_onSigninSuccess() {
        activityRule.runOnUiThread {
