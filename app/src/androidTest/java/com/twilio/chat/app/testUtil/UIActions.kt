...
import com.twilio.chat.app.CONDITION_CHECK_INTERVAL
import com.twilio.chat.app.CONDITION_CHECK_TIMEOUT
...
fun switchChannelTab(name: String) = WaitForViewMatcher.performOnView(withText(name), click())
